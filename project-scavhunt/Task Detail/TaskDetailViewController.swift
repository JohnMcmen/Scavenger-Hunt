...
class TaskDetailViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        // Check if the segue is the one you set for transitioning to PhotoViewController
        if segue.identifier == "PhotoSegue" {
            // Cast the destination view controller to PhotoViewController
            if let photoViewController = segue.destination as? PhotoViewController {
                // Pass the task data to PhotoViewController
...
// Add conformance to PHPickerViewControllerDelegate
